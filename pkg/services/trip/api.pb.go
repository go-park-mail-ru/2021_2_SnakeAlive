...
var file_pkg_services_trip_api_proto_rawDesc = []byte{
	...
	0xfa, 0x42, 0x04, 0x22, 0x02, 0x20, 0x00, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x32,
	0xca, 0x02, 0x0a, 0x0b, 0x54, 0x72, 0x69, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	...
	0x00, 0x12, 0x51, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x28, 0x2e, 0x73, 0x65,
	...
	0x69, 0x70, 0x22, 0x00, 0x12, 0x46, 0x0a, 0x06, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x22,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x74, 0x72, 0x69, 0x70, 0x5f, 0x73,
...
var file_pkg_services_trip_api_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_pkg_services_trip_api_proto_depIdxs = []int32{
	...
	0, // 2: services.trip_service.TripService.GetTrip:input_type -> services.trip_service.TripRequest
	3, // 3: services.trip_service.TripService.AddTrip:input_type -> services.trip_service.ModifyTripRequest
	3, // 4: services.trip_service.TripService.Update:input_type -> services.trip_service.ModifyTripRequest
	0, // 5: services.trip_service.TripService.Delete:input_type -> services.trip_service.TripRequest
	2, // 6: services.trip_service.TripService.GetTrip:output_type -> services.trip_service.Trip
	2, // 7: services.trip_service.TripService.AddTrip:output_type -> services.trip_service.Trip
	2, // 8: services.trip_service.TripService.Update:output_type -> services.trip_service.Trip
	4, // 9: services.trip_service.TripService.Delete:output_type -> google.protobuf.Empty
