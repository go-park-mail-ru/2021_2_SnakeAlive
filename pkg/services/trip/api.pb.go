...
var file_pkg_services_trip_api_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x64, 0x61, 0x79, 0x22, 0xc5, 0x01, 0x0a, 0x04, 0x54, 0x72, 0x69, 0x70, 0x12, 0x0e,
	...
	,
...
var file_pkg_services_trip_api_proto_depIdxs = []int32{
	...
	2,  // 17: services.trip_service.TripService.GetTrip:output_type -> services.trip_service.Trip
	2,  // 18: services.trip_service.TripService.AddTrip:output_type -> services.trip_service.Trip
	2,  // 19: services.trip_service.TripService.UpdateTrip:output_type -> services.trip_service.Trip
	12, // 20: services.trip_service.TripService.DeleteTrip:output_type -> google.protobuf.Empty
	10, // 21: services.trip_service.TripService.GetTripsByUser:output_type -> services.trip_service.Trips
	5,  // 22: services.trip_service.TripService.GetAlbum:output_type -> services.trip_service.Album
	5,  // 23: services.trip_service.TripService.AddAlbum:output_type -> services.trip_service.Album
	5,  // 24: services.trip_service.TripService.UpdateAlbum:output_type -> services.trip_service.Album
	12, // 25: services.trip_service.TripService.DeleteAlbum:output_type -> google.protobuf.Empty
	8,  // 26: services.trip_service.TripService.SightsByTrip:output_type -> services.trip_service.Sights
	11, // 27: services.trip_service.TripService.GetAlbumsByUser:output_type -> services.trip_service.Albums
